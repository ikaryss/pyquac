...
class Tts(Spectroscopy):
    ...
    def __init__(
        ...
        *,
        ...
        x_arr=None,
        y_arr=None,
        hdawg_port: str = "127.0.0.1",
        hdawg_port1: int = 8004,
        hdawg_mode: int = 6,
        ...
        # HDAWG or CS init
        if not self.cs_mode:
            self.hdawg = zhinst.ziPython.ziDAQServer(
                hdawg_port, hdawg_port1, hdawg_mode
            )
            self.hdawg_setDouble = (
                "/"
                + self.hdawg_device
                + "/sigouts/"
                + str(self.hdawg_channel)
                + "/offset"
            )
            # open HDAWG ZI
    ...
    def run_measurements(
        ...
        *,
        ...
        if not self.cs_mode:
            self.hdawg.setInt(
                "/" + self.hdawg_device + "/sigouts/" + str(self.hdawg_channel) + "/on",
                1,
            )
        else:
            self.cs.output_on()
        ...
        try:
            for i in range(len(self.load)):
                ...
                self.write(
                    x=self.load[i], y=self.frequency[i], z=20 * np.log10(abs(result)[0])
                )
                timer.sleep(sleep)
    ...
    def dump_data(self, path: None):
        data = {
            "x_list": self.x_list,
            "y_list": self.y_list,
            "LO_qubit_power": self.LO_set_power,
            "LO_res_power": self.LO_res_set_power,
            "res_bandwidth": self.LO_res_set_bandwidth,
            "qubit_bandwidth": self.base_bandwidth,
...
class Sts2Q(Spectroscopy):
    ...
    def __init__(
        ...
        *,
        ...
        x_max_target=None,
        x_step_target=None,
        nx_points_target=None,
        x_min_control=None,
        x_max_control=None,
        x_step_control=None,
        nx_points_control=None,
        x_arr=None,
        y_arr=None,
        x_arr_target=None,
        x_arr_control=None,
        ...
        hdawg_mode: int = 6,
        hdawg_device: str = "dev8210",
        hdawg_host_coupler: str = "127.0.0.1",
        hdawg_port_coupler: int = 8004,
        hdawg_mode_coupler: int = 6,
        ...
        if compensation_matrix is None:
            ...
            if (x_min_target is not None) or (x_arr_target is not None):
                self.target_STS = Spectroscopy(
                    x_min=x_min_target,
                    x_max=x_max_target,
                    nx_points=nx_points_target,
                    y_min=y_min,
                    y_max=y_max,
                    ny_points=ny_points,
                    x_step=x_step_target,
                    y_step=y_step,
                    x_arr=x_arr_target,
                    y_arr=y_arr,
                )
            if (x_min_control is not None) or (x_arr_control is not None):
                self.control_STS = Spectroscopy(
                    x_min=x_min_control,
                    x_max=x_max_control,
                    nx_points=nx_points_control,
                    y_min=y_min,
                    y_max=y_max,
                    ny_points=ny_points,
                    x_step=x_step_control,
                    y_step=y_step,
                    x_arr=x_arr_control,
                    y_arr=y_arr,
                )
        ...
        self.hdawgC = zhinst.ziPython.ziDAQServer(
            hdawg_host_coupler, hdawg_port_coupler, hdawg_mode_coupler
        )
        _ = self.hdawgC.awgModule()
    ...
    def run_measurements(self, *, sleep=0.0007):
        ...
        if self.target_STS is not None:
            self.target_STS.iter_setup(
                x_key=None, y_key=None, x_min=None, x_max=None, y_min=None, y_max=None
            )
        if self.control_STS is not None:
            self.control_STS.iter_setup(
                x_key=None, y_key=None, x_min=None, x_max=None, y_min=None, y_max=None
            )
        ...
        if self.target_ch is not None:
            self.hdawg.setInt(
                "/" + self.hdawg_device + "/sigouts/" + str(self.target_ch) + "/on", 1
            )
            time.sleep(0.5)

        if self.coupler_ch is not None:
            self.hdawgC.setInt(
                "/" + self.hdawg_deviceC + "/sigouts/" + str(self.coupler_ch) + "/on", 1
            )
            time.sleep(0.5)

        if self.control_ch is not None:
            self.hdawg.setInt(
                "/" + self.hdawg_device + "/sigouts/" + str(self.control_ch) + "/on", 1
            )
            time.sleep(0.5)
                ...
                if (i == 0) or (self.load[i] != self.load[i - 1]):
                    ...
                    if (self.target_ch is not None) and (self.target_STS is None):
                        ...
                        self.hdawg.setDouble(
                            ...
                            + str(self.target_ch)
                            + "/offset",
                            self.target_STS.load[i],
                        )

                    "coupler qubit"
                    if self.coupler_ch is not None:
                        self.hdawgC.setDouble(
                            "/"
                            + self.hdawg_deviceC
                            + "/sigouts/"
                            + str(self.coupler_ch)
                    ...
                    elif (self.control_ch is not None) and (
                        self.control_STS is not None
                    ):
                        self.hdawg.setDouble(
                            "/"
                            + self.hdawg_device
        ...
        if self.target_ch is not None:
            self.hdawg.setInt(
                "/" + self.hdawg_device + "/sigouts/" + str(self.target_ch) + "/on", 0
            )
            time.sleep(0.5)

        if self.coupler_ch is not None:
            self.hdawgC.setInt(
                "/" + self.hdawg_deviceC + "/sigouts/" + str(self.coupler_ch) + "/on", 0
            )
            time.sleep(0.5)

        if self.control_ch is not None:
            self.hdawg.setInt(
                "/" + self.hdawg_device + "/sigouts/" + str(self.control_ch) + "/on", 0
            )
            time.sleep(0.5)
    ...
    def fit_and_offset(
        ...
        (
            ...
            glob_h_mi,
            glob_h_ma,
        ) = self._TwoToneSpectroscopy__define_heat_sample_on(
            x_set, info=False, plot=False, q_max=95, q_min=5
        )
        ...
        for xx in x_set:
            ...
            temp_y_idx = (
                (
                    X[
                        (X.x_value == xx) & (X.y_value >= y_min) & (X.y_value <= y_max)
                    ].heat_value
                    - glob_samp
                )
                .abs()
        ...
        if freq_for_offset is not None:
            volt = x_list[
                (x_list >= voltage_boundary[0]) & (x_list <= voltage_boundary[1])
            ]
            delta_f = abs(fit - freq_for_offset)[
                (x_list >= voltage_boundary[0]) & (x_list <= voltage_boundary[1])
            ]
...
class Sts2QContainer:
    def __init__(
        ...
        *,
        ...
        self.Q1 = Sts2Q(
            x_min=x_minQ1,
            x_max=x_maxQ1,
            nx_points=nx_pointsQ1,
            x_step=x_stepQ1,
            x_arr=x_arrQ1,
            y_min=y_minQ1,
            y_max=y_maxQ1,
            y_step=y_stepQ1,
            ny_points=ny_pointsQ1,
            y_arr=y_arrQ1,
            target_ch=q1_ch,
            readout_qubit="Q1",
            flux_qubit="Q1",
            hdawg_host=hdawg_host,
            hdawg_port=hdawg_port,
            hdawg_mode=hdawg_mode,
            hdawg_device=hdawg_device,
            hdawg_host_coupler=hdawg_host_coupler,
            hdawg_port_coupler=hdawg_port_coupler,
            hdawg_mode_coupler=hdawg_mode_coupler,
            hdawg_device_coupler=hdawg_device_coupler,
            LO_res_port=LO_res_port,
            LO_res_set_bandwidth=LO_res_set_bandwidth,
            LO_res_set_power=LO_res_set_power,
            LO_res_set_averages=LO_res_set_averages,
        )

        self.Q1_Coupler = Sts2Q(
            x_min=x_minC,
            x_max=x_maxC,
            nx_points=nx_pointsC,
            x_step=x_stepC,
            x_arr=x_arrC,
            y_min=y_minQ1,
            y_max=y_maxQ1,
    ...
    def final_matrix_old(self):
        ...
        a12 = (
            Q1_offset_base / Q2_offset
            if self.Q1_Q2.finished and self.Q1.finished
            else None
        )

        Q1_coupler_offset = (
            self.Q1_Coupler.x_offset if self.Q1_Coupler.finished else None
        )
        a13 = (
            Q1_offset_base / Q1_coupler_offset
            if self.Q1_Coupler.finished and self.Q1.finished
            else None
        )
        ...
        a21 = (
            Q2_offset_base / Q1_offset
            if self.Q2_Q1.finished and self.Q2.finished
            else None
        )
        ...
        Q2_coupler_offset = (
            self.Q2_Coupler.x_offset if self.Q2_Coupler.finished else None
        )
        a23 = (
            Q2_offset_base / Q2_coupler_offset
            if self.Q2_Coupler.finished and self.Q2.finished
            else None
        )
    ...
    def final_matrix(self):
        ...
        a13 = (
            Q1_coupler_offset / last_point_Q1
            if self.Q1_Coupler.finished and self.Q1.finished
            else None
        )
        ...
        a23 = (
            Q2_coupler_offset / last_point_Q2
            if self.Q2_Coupler.finished and self.Q2.finished
            else None
        )
...
class Tts2Q(Spectroscopy):
        ...
        *,
        ...
        if compensation_matrix is not None:
            if x_arr is None:
                ...
                target_x_list = new_x_matrix[0]
                control_x_list = new_x_matrix[1]
                print("target_x_list", target_x_list)
                print("control_x_list", control_x_list)
        else:
            pass
    ...
    def run_compensation_measurements(
        self,
        *,
        x_key: Union[float, int, Iterable] = None,
        y_key: Union[float, int, Iterable] = None,
...
class Tts_4Q(Spectroscopy):
    ...
    def __init__(
        ...
        *,
        ...
        hdawg_port1: int = 8004,
        hdawg_mode: int = 6,
        hdawg_device_1: str = "dev8210",
        hdawg_device_2: str = "dev8307",
        hdawg_channel_2: int = 5,
        LO_port: str = "TCPIP0::192.168.180.143::hislip0::INSTR",
        LO_res_port: str = "TCPIP0::192.168.180.110::inst0::INSTR",
        LO_set_power: int = 5,
        LO_res_set_bandwidth: int = 20,
        ...
        self.fr_min = fr_min
        self.fr_max = fr_max
        self.hdawg_device_1 = hdawg_device_1
        self.hdawg_channel_2 = hdawg_channel_2
        self.hdawg_device_2 = hdawg_device_2
        ...
        # HDAWG or CS init
        if not self.cs_mode:
            self.hdawg_1 = zhinst.ziPython.ziDAQServer(
                hdawg_port, hdawg_port1, hdawg_mode
            )

            self.hdawg_2 = zhinst.ziPython.ziDAQServer(
                hdawg_port, hdawg_port1, hdawg_mode
            )
            self.hdawg_setDouble_2 = (
                "/"
                + self.hdawg_device_2
                + "/sigouts/"
                + str(self.hdawg_channel_2)
                + "/offset"
            )
            # open HDAWG ZI
            _ = self.hdawg_1.awgModule()
            _ = self.hdawg_2.awgModule()
        else:
            self.cs = K6220(cs_device)
    ...
    def spectroscopy_preset_on(self, hdawg_n):
        # readout
        self.LO_res.set_power(-10)
        self.LO_res.set_power_on()
        self.hdawg_1.setDouble(f"/{self.hdawg_device_1}/sigouts/0/offset", 0.6)
        self.hdawg_1.setDouble(f"/{self.hdawg_device_1}/sigouts/1/offset", 0.6)
        self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/0/on", 1)
        self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/1/on", 1)
        # qubit
        self.LO.set_status(0)
        if hdawg_n == 1:
            self.hdawg_1.setDouble(
                f"/{self.hdawg_device_1}/sigouts/{self.ch_I}/offset", 0.4
            )
            self.hdawg_1.setDouble(
                f"/{self.hdawg_device_1}/sigouts/{self.ch_Q}/offset", 0.4
            )
            self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/{self.ch_I}/on", 1)
            self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/{self.ch_Q}/on", 1)
        else:
            self.hdawg_2.setDouble(
                f"/{self.hdawg_device_2}/sigouts/{self.ch_I}/offset", 0.4
            )
            self.hdawg_2.setDouble(
                f"/{self.hdawg_device_2}/sigouts/{self.ch_Q}/offset", 0.4
            )
            self.hdawg_2.setInt(f"/{self.hdawg_device_2}/sigouts/{self.ch_I}/on", 1)
            self.hdawg_2.setInt(f"/{self.hdawg_device_2}/sigouts/{self.ch_Q}/on", 1)

    def spectroscopy_preset_off(self, ch_I, ch_Q, hdawg_n):
        # readout
        self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/0/on", 0)
        self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/1/on", 0)
        # qubit
        if hdawg_n == 1:
            self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/{self.ch_I}/on", 0)
            self.hdawg_1.setInt(f"/{self.hdawg_device_1}/sigouts/{self.ch_Q}/on", 0)
        else:
            self.hdawg_2.setInt(f"/{self.hdawg_device_2}/sigouts/{self.ch_I}/on", 0)
            self.hdawg_2.setInt(f"/{self.hdawg_device_2}/sigouts/{self.ch_Q}/on", 0)
        ...
        *,
        ...
        try:
            for i in range(len(self.load)):
                ...
                if not self.cs_mode:
                    self.hdawg_2.setDouble(
                        self.hdawg_setDouble_2, self.load[i]
                    )  # Voltage write
                else:
                    self.cs.write("CURRent {}".format(self.load[i]))  # Current write
